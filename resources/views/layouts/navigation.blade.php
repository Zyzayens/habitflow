<nav x-data="{ open: false }" class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('welcome') }}" class="flex items-center">
                    ...
                    <span class="ml-2 text-lg font-bold text-gray-800 dark:text-gray-100">HabitFlow</span>
                </a>
                ...
                <div class="ml-4 flex items-center gap-2">
                    <span class="text-lg text-gray-800 dark:text-gray-100">Day</span>
                    ...
                    <span class="text-lg text-gray-800 dark:text-gray-100">Night</span>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="px-4">
                <a href="{{ route('login') }}" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Log in') }}</a>
                @if(Route::has('register'))
                    <a href="{{ route('register') }}" class="mt-2 block text-sm font-medium text-indigo-600 dark:text-indigo-400">{{ __('Register') }}</a>
                @endif
            </div>
        @endauth
        </div>
